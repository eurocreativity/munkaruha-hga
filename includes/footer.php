          ...
          <div id="help-pane-scanner" class="help-pane hidden space-y-3">
            <?php if (!$isHelpViewer): ?>
              ...
              <div class="space-y-2">
                ...
                <p><strong>📱 Mobil Vonalkód Terminál (`mobile.php`):</strong> Kifejezetten okostelefonokra tervezett, egykezes gyorsfelület élő kamerás vonalkód-olvasóval, vaku (zseblámpa) támogatással, rezgő visszajelzéssel, azonnali státuszfrissítéssel és beépített Teszt móddal!</p>
